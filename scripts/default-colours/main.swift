...
/**
 Swift script parsing all our color assets and generating a file containing a dictionary with all our client tints
 
 NOTE - The file has to be called main.swift to run, don’t change it.
 If you need several scripts, create a subdirectory for each and call all of them main.swift.
...
let filePathURL = rootPathURL.appendingPathComponent("ColorsEverywhere/Generated")
